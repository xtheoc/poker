...
export const CTM_NL2_LEARNING: StrategyLearningSystem = {
  ...
  lessons: [
    ...
    },
    {
      ...
      assets: [
        { id: "checked-to-you", kind: "rewrite", title: "Lane A. It checks to you", body: "Three or more players? You need top pair or a strong draw. Without one, check. Heads-up? Go to the bet test.\n\nBet test: name one worse hand that calls, then value bet. If you cannot, name one better hand that folds and one turn card that helps you, then semi-bluff. If you cannot name either, check.", sources: [book([130, 151], "Planning a hand and c-bet exceptions")] },
        ...
        { id: "cbet-sizes", kind: "rewrite", title: "Only after you choose BET: pick the size", body: "The size chart does not tell you whether to bet. Lane A decides that first.\n\n55%: dry ace- or king-high board, you missed, two low cards, no flush draw. 60%: your usual bluff size. 75%: good hand against a sticky regular. 100%: top pair good kicker or better against a fish or SLP. 150%: a monster against a calling station.", sources: [book([132, 151], "C-bet plans and sizing")] },
      ],
      mastery: [{ kind: "drill", drillId: "flop-plan", minimumRuns: 2, minimumAccuracy: 85 }],
      playbook: [{ id: "flop", heading: "Flop choice map", takeaway: "Lane A: it checks to you. Lane B: someone bets first. The sizing chart is used only after Lane A ends in BET.", sources: [book([130, 151], "Flop")]}],
    },
    {
