...
const TEMPLATES: readonly ContextTemplate[] = [
  ...
  { id: "value-3bet-queens", scenario: "vs-rfi", position: "BTN", villain: "CO", hand: "QQ", stackBb: 100 },
  { id: "value-3bet-aces", scenario: "vs-rfi", position: "BB", villain: "BTN", hand: "AA", stackBb: 100 },
  { id: "flat-strong", scenario: "vs-rfi", position: "BTN", villain: "UTG", hand: "AQs", stackBb: 100 },
  { id: "flat-strong-jacks", scenario: "vs-rfi", position: "CO", villain: "HJ", hand: "JJ", stackBb: 100 },
  { id: "flat-strong-tens", scenario: "vs-rfi", position: "BTN", villain: "CO", hand: "TT", stackBb: 100 },
  { id: "flat-strong-aqo", scenario: "vs-rfi", position: "BTN", villain: "HJ", hand: "AQo", stackBb: 100 },
  { id: "set-mine-ip", scenario: "vs-rfi", position: "BTN", villain: "CO", hand: "55", stackBb: 50 },
  { id: "set-mine-ip-small", scenario: "vs-rfi", position: "CO", villain: "HJ", hand: "22", stackBb: 65 },
  { id: "set-mine-oop", scenario: "vs-rfi", position: "BB", villain: "BTN", hand: "55", stackBb: 70 },
  { id: "set-mine-oop-sixes", scenario: "vs-rfi", position: "BB", villain: "CO", hand: "66", stackBb: 85 },
  { id: "set-mine-shallow", scenario: "vs-rfi", position: "BTN", villain: "CO", hand: "55", stackBb: 40 },
  { id: "set-mine-oop-shallow", scenario: "vs-rfi", position: "BB", villain: "BTN", hand: "99", stackBb: 50 },
  {
  ...
  { id: "default-fold-small-blind", scenario: "vs-rfi", position: "SB", villain: "BTN", hand: "K7o", stackBb: 100 },
  { id: "default-fold-big-blind", scenario: "vs-rfi", position: "BB", villain: "HJ", hand: "T6s", stackBb: 100 },
  {
    id: "squeeze-value-ip",
    scenario: "squeeze",
    position: "BTN",
  ...
  { id: "four-bet-value-aces", scenario: "vs-3bet", position: "BTN", villain: "SB", hand: "AA", stackBb: 100 },
  { id: "four-bet-value-jacks", scenario: "vs-3bet", position: "HJ", villain: "CO", hand: "JJ", stackBb: 100 },
  { id: "four-bet-value-aks", scenario: "vs-3bet", position: "CO", villain: "BTN", hand: "AKs", stackBb: 100 },
  { id: "call-3bet", scenario: "vs-3bet", position: "CO", villain: "BTN", hand: "AQo", stackBb: 100 },
  { id: "call-3bet-eights", scenario: "vs-3bet", position: "BTN", villain: "SB", hand: "88", stackBb: 100 },
  { id: "call-3bet-nines", scenario: "vs-3bet", position: "HJ", villain: "CO", hand: "99", stackBb: 100 },
  { id: "short-stack-no-call", scenario: "vs-3bet", position: "CO", villain: "BTN", hand: "TT", stackBb: 50 },
  { id: "short-stack-no-call-aq", scenario: "vs-3bet", position: "BTN", villain: "SB", hand: "AQs", stackBb: 45 },
  { id: "fold-3bet", scenario: "vs-3bet", position: "CO", villain: "BTN", hand: "KQs", stackBb: 100 },
  { id: "four-bet-continue", scenario: "vs-4bet", position: "BTN", villain: "CO", hand: "KK", stackBb: 100 },
  { id: "four-bet-continue-aces", scenario: "vs-4bet", position: "CO", villain: "BTN", hand: "AA", stackBb: 100 },
  { id: "four-bet-fold", scenario: "vs-4bet", position: "BTN", villain: "CO", hand: "QQ", stackBb: 100 },
  { id: "four-bet-fold-jacks", scenario: "vs-4bet", position: "CO", villain: "BTN", hand: "JJ", stackBb: 100 },
  { id: "four-bet-fold-ace-king", scenario: "vs-4bet", position: "BTN", villain: "CO", hand: "AKs", stackBb: 100 },
  {
    id: "deep-nit-kings",
    scenario: "vs-4bet",
    position: "BTN",
...
const OPENING_TEMPLATES: readonly OpeningTemplate[] = [
  ...
  { id: "open-utg-pair", position: "UTG", hand: "44", expected: "raise", summary: "Open this pair from early position." },
  ...
  { id: "open-hj-pair", position: "HJ", hand: "88", expected: "raise", summary: "Open this pair from middle position." },
  { id: "open-hj-fold", position: "HJ", hand: "Q8o", expected: "fold", summary: "Fold this hand from middle position." },
  { id: "open-co-value", position: "CO", hand: "A5o", expected: "raise", summary: "Open this hand from late position." },
  { id: "open-co-connector", position: "CO", hand: "86s", expected: "raise", summary: "Open this suited connector from late position." },
  { id: "open-co-fold", position: "CO", hand: "Q5o", expected: "fold", summary: "Fold this hand from late position." },
  { id: "open-btn-value", position: "BTN", hand: "Q7s", expected: "raise", summary: "Open this hand on the button." },
  { id: "open-btn-connector", position: "BTN", hand: "64s", expected: "raise", summary: "Open this suited connector on the button." },
  { id: "open-btn-fold", position: "BTN", hand: "T4o", expected: "fold", summary: "Fold this hand on the button." },
  { id: "open-sb-fold", position: "SB", hand: "J7o", expected: "fold", summary: "Fold this hand from the small blind." },
  { id: "open-sb-value", position: "SB", hand: "AJo", expected: "raise", summary: "Open this hand from the small blind." },
];
